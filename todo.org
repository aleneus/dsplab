...
** TODO [t] Remove info from examples
** TODO [t] Remove set_descr() from examples
** TODO [t] Deprecate descr=None in plan
** TODO [t] Refactor activity.get_work_from_dict()
** TODO [t] Check and update old tests
** TODO [t] Rename Node.reset() to Node.clear_result()
* 0.38.1
