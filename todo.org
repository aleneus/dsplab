...
** TODO [e] Add Returns to docstring of Plan
** TODO [p] Remove reset() in Node (after implementing method for finding sequence)
** TODO [p] Some examples seems to be excess
** TODO [p] Clean Plan.info() by replace \'{}\'.format to str()
** TODO [t] Add online example to docs
** TODO [t] Update whats new in docs
* 0.32.6
** TODO [e] Add comment showing desirable result in plan examples
** TODO [t] Brush plan.py
** TODO [t] Brush demos
** TODO [e] Doc parameters and returns in plan.py
* later
** TODO [p] Add example of validation of plan
** TODO [p] Add validate() method to Plan
