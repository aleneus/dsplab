...
** TODO [t] Remove as_string from all demos
** TODO [e] Restructure todo (add level to hierarchy)
* 0.38.0
** TODO [t] Worker: Deprecate public add_param(), define _add_param()
** TODO [t] Deprecate as_string parameter in info()
* 0.40.0
** TODO [t] Worker: remove deprecated add_param()
** TODO [t] Remove deprecated as_string in info()
* later
** TODO [t] Inspect tests folder
** TODO [e] Up pylint result for demos to 6
...
** TODO [p] Rename Worker.add_param() to Worker._add_param()
