...
** TODO [t] Add CsvDataProducer
** TODO [t] Add example for SignalPlayer
** TODO [t] Add player stuff to docs
* later major
...
** TODO [e] Activity, Plan: doc keys in settings used in setup_from_dict()
