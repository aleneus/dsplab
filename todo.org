...
** TODO [p] Add method for adding and documenting parameters of activity
** TODO [p] Remove set_description method from activity
** TODO [t] Update activity and plan examples
** TODO [t] Plan: Remove deprecated setup_plan()
** TODO [t] Make correct universal arguments of Activity.__call__
...
* later minor
** TODO [t] Use workers from special unit in the plan examples
