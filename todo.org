...
** TODO [b] Timestamps: UTC time is not converted if the delimiter is colon
* 0.26.0
** TODO [b] Modulation: different kind of modulation gives different length of output signal
** TODO [t] Modulation. Return angles from fm()
