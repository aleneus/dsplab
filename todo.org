...
** TODO [b] Activity: Add * to kwargs in work.__call__()
** TODO [t] Plan: Add a worker with no init args to the example of setup_plan
** TODO [b] Acrivity: Work: worker is a function, info()
** TODO [t] Remove io.py from dsplab
** TODO [b] Plan: setup_plan(): work is a class with no args in init
* 0.25.1
