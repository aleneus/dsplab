...
** TODO [t] Add example of SelectNode to demos
** TODO [t] Correct process multiple input in MapNode
** TODO [t] Add example of SelectNode to docs
** TODO [e] Map node example: run plan in one line
** TODO [b] Allow inputs in __init__ of each type of node
* 0.32.4
