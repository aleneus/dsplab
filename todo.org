...
** DONE plan.py: set the required types to arguments
...
* Enhancement
** TODO Refactoring of is_iterable sruff in Plan.__call__
** TODO Refactoring of setup_plan
** TODO Possibility to run Plan of one value, not list
