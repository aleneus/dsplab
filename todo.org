...
** TODO [t] Change History header in index.rst
** TODO [b] Change docstring for set_descr() in Activity
* 0.31.0
** TODO [t] Add smooth function from es_analytics to filtration
** TODO [t] Merge frequency unit to modulation one
...
** TODO [e] Add examples of modulation to docs
