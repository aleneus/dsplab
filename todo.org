...
** DONE fix: online: Or
* 0.39.1
** TODO depl: homepage: bitbucket -> github
** TODO depl: list of demo and automation of run
** TODO depl: setup.py: fix long-description (must be in rst format)
** TODO docs: README: pip install -> pip3 install
** TODO docs: explicit authors and e-mails
* 0.40.0
** TODO feat: remove t argument from noise functions
** TODO feat: modulation: rearange args
** TODO ref: modulation: noise_f -> noise_ph
** TODO ref: modulation: noise_s -> noise_amp
...
** TODO ref: activity.get_work_from_dict(): Too nested work with params
...
** TODO otp: work with data in Plan and Nodes
...
* deprecations
** TODO depr: remove Worker.add_param()
   SCHEDULED: <2021-06-01>
** TODO depr: remove info()
   SCHEDULED: <2021-06-01>
** TODO depr: remove set_descr() in activities
   SCHEDULED: <2021-06-01>
** TODO depr: remove Activity.set_descr()
   SCHEDULED: <2021-06-01>
** TODO depr: remove Node.reset()
   SCHEDULED: <2021-06-01>
** TODO depr: remove plan.py
   SCHEDULED: <2021-06-01>
** TODO depr: remove activity.py
   SCHEDULED: <2021-06-01>
** TODO depr: remove online.py
   SCHEDULED: <2021-06-01>
