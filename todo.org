...
** DONE ref: add plan subpackage
** DONE ref: add flow subpackage
** DONE depl: flow: add to setup script
** DONE ref: online -> flow
** TODO lint: ignore deprecated modules
** TODO docs: flow: add
** TODO demo: update using flow
** TODO ref: fix deprecation warinings
** TODO feat: verification of the plan
** TODO docs: update authors
* 0.40.0
...
** TODO feat: remove deprecated plan.py
** TODO feat: remove deprecated activity.py
** TODO feat: remove deprecated online.py
